...
<body class="form"
    style="backdrop-filter: blur(3px); background-image: url({{ asset('assets/img/categories/sekolah.jpg') }}); background-size: cover;">
            ...
            <div class="form-form-wrap">
                <div class="form-container">
                    <div class="form-content" style="background-color: #00000040; border: none;">
                        ...
                        <img class="rounded-circle" src="{{ asset('assets/img/avatar/spp1.jpg') }}" alt="logo"
                            style="height: 100px;">
