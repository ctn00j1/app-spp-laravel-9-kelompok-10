...
<head>
    ...
    <title>E-Spp</title>
    <link rel="shortcut icon" href="{{ asset('assets/img/avatar/spp1.jpg') }}" type="image/x-icon">
...
<body>
    <div class="card p-3 px-5 p-4">
        ...
        <p class="text-center text-capitalize fw-bold h5 ">Sekolah Tinggi wastu</p>
        <div class="text-center fw-bold">
            <p class="mt-2 mb-0">Jl. sadang depan Gang</p>
        </div>
                    ...
                    <tbody>
                        ...
                        <tr>
                            <td class="text-center pt-1 py-4 h6">Bendahara Sekolah,<span
                                    class="row pt-5 py-5 fw-bold mt-5 justify-content-center">alfacell.S.Pd</span>
                            </td>
                        </tr>
                    </tbody>
                </table>
